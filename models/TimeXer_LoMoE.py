...
from models.TimeXer import FlattenHead, Model as TimeXerBase
from utils.ts_stats import FeatureExtractionConfig


class Model(TimeXerBase):
    """TimeXer backbone enhanced with a lightweight MoE prediction head."""
    ...
    def _apply_head(self, enc_out: torch.Tensor, stats_source: Optional[torch.Tensor]):
        if self._lomoe_active:
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        head_out = self._apply_head(enc_out, stats_source)
